...
ATT.Category = {"go_skins_famas"}

ATT.SubMaterial0 = "csgoskins/antiqued/famas_" .. name
ATT.SubMaterial1 = "csgoskins/antiqued/famas_" .. name

ARC9.LoadAttachment(ATT, "moka_csgo_skin_famas_" .. name)
------------------------------------------------------------------
ATT = {}
local name = "jinn"
...
-- ATT.Category = {"go_skins_famas"}
-- ATT.SubMaterial0 = "csgoskins/custom/famas_" .. name
-- ATT.SubMaterial1 = "csgoskins/custom/famas_" .. name

-- ARC9.LoadAttachment(ATT, "moka_csgo_skin_famas_" .. name)
------------------------------------------------------------------
ATT = {}
local name = "holo_ocean"

ATT.MenuCategory = "ARC9 - CSGO Attachments"
ATT.PrintName = "Waters of Nephthys"
ATT.Description = ""
ATT.Icon = Material("csgoskins/Icons/famas_" .. name .. ".png", "mips smooth")
...
ATT.SubMaterial0 = "csgoskins/gunsmith/famas_" .. name
ATT.SubMaterial1 = "csgoskins/gunsmith/famas_" .. name

ARC9.LoadAttachment(ATT, "moka_csgo_skin_famas_" .. name)
------------------------------------------------------------------
ATT = {}
local name = "legacy_gold"
