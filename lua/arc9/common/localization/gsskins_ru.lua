...
secret = "Коллекция «117 110 117 115 101 100»"
}
...
-- [[ Antiqued ]]
L[skin .. "cartel.printname"] = wpns .. "Картель"
L[skin .. "cartel.compactname"] = "Картель"
L[skin .. "cartel.description"] = collection.chroma .. "\n" .. [[

Нанесена гравировка в виде цветов, черепов и змей.

«Спуск курка может обратить любой день в День Мертвых»]]
------------------------------------

-- [[ Custom ]]
L[skin .. "island_floral.printname"] = wpns .. "Дикий лотос"
L[skin .. "island_floral.compactname"] = "Дикий лотос"
...
------------------------------------
L[skin .. "xray.printname"] = wpns .. "Рентген"
L[skin .. "xray.compactname"] = "Рентген"
L[skin .. "xray.description"] = collection.havoc .. "\n" .. [[

На оружие нанесен рентгеновский снимок внутреннего механизма AK-47.

«Неприкрытая истина не каждому придётся по душе...»]]
------------------------------------
L[skin .. "fireserpent.printname"] = wpns .. "Огненный змей"
L[skin .. "fireserpent.compactname"] = "Огненный"
...
------------------------------------
L[skin .. "panther.printname"] = wpns .. "Ягуар"
L[skin .. "panther.compactname"] = "Ягуар"
L[skin .. "panther.description"] = collection.esports14 .. "\n" .. [[

На это оружие нанесено изображение ягуара на фоне тигрового камуфляжа.]]
------------------------------------
L[skin .. "pinstripe.printname"] = wpns .. "Изумрудные завитки"
L[skin .. "pinstripe.compactname"] = "Изумрудные"
L[skin .. "pinstripe.description"] = collection.bank .. "\n" .. [[

Дубовая поверхность покрыта белыми и зелеными завитками.

«Не доверяешь моей дочери? Значит, не доверяешь и мне. Успокойся, выпей, и уж тогда побеседуем» - Отец и Феникс, часть 2]]
------------------------------------
L[skin .. "well_travelled.printname"] = wpns .. "Путешественник"
L[skin .. "well_travelled.compactname"] = "Путешествие"
L[skin .. "well_travelled.description"] = collection.baggage .. "\n" .. [[

Его приклад обернут коричневой кожей. Это оружие побывало во многих городах.

«Достаточно присмотреться к ней, и поймешь, что она сделала. На решение у нас мало времени...» - Отцовская любовь, часть 1]]
------------------------------------
L[skin .. "headshot.printname"] = wpns .. "Выстрел в голову"
L[skin .. "headshot.compactname"] = "Выстрел в г."
...
------------------------------------
L[skin .. "neonrider.printname"] = wpns .. "Неоновый гонщик"
L[skin .. "neonrider.compactname"] = "Неон"
L[skin .. "neonrider.description"] = collection.horizon .. "\n" .. [[

Нанесено изображение беспощадного байкера на фоне смешавшихся неоновых узоров.

«Две доли привета из прошлого, три доли синтезатора»]]
------------------------------------
L[skin .. "anubis.printname"] = wpns .. "Легион Анубиса"
L[skin .. "anubis.compactname"] = "Л.A."
L[skin .. "anubis.description"] = collection.fracture .. "\n" .. [[

На корпус нанесён рисунок египетских богов Анубиса и Ра, олицетворяющий баланс между жизнью и смертью.

«Да склонится чаша весов в вашу пользу»]]
------------------------------------
L[skin .. "asiimov.printname"] = wpns .. "Азимов"
L[skin .. "asiimov.compactname"] = "Азимов"
L[skin .. "asiimov.description"] = collection.dangerzone .. "\n" .. [[

Раскрашено вручную в стиле научной фантастики.

«Кто угодно может предсказать будущее… но лишь мечтатель претворяет его в жизнь»]]
------------------------------------
L[skin .. "aztec.printname"] = wpns .. "Затерянная земля"
L[skin .. "aztec.compactname"] = "Затерянная"
L[skin .. "aztec.description"] = collection.prisma .. "\n" .. [[

На корпус вручную нанесли различные племенные узоры.

«Мы все в одном каноэ»]]
------------------------------------
L[skin .. "cogthings.printname"] = wpns .. "Ледяной уголь"
L[skin .. "cogthings.compactname"] = "Ледяной у."
...
«Холоден на ощупь»]]
------------------------------------
L[skin .. "courage.printname"] = wpns .. "Аквамариновая месть"
L[skin .. "courage.compactname"] = "Аквамарин."
L[skin .. "courage.description"] = collection.falchion .. "\n" .. [[

Украшено на заказ изображением стаи дельфинов.

«Здесь есть эхо?»]]
------------------------------------
L[skin .. "mastery.printname"] = wpns .. "Элитное снаряжение"
L[skin .. "mastery.compactname"] = "Элитное"
L[skin .. "mastery.description"] = collection.chroma2 .. "\n" .. [[

Окрашено вручную с использованием аквапечати, трафаретных изображений и термонаклеек.

«Ступай осторожней, Наоми… люди твоей профессии обычно не живут долго», — Щит и Змей, часть 2]]
------------------------------------
L[skin .. "nightwish.printname"] = wpns .. "Пожелание на ночь"
L[skin .. "nightwish.compactname"] = "Пожелание"
...
------------------------------------
L[skin .. "phantom_disruptor.printname"] = wpns .. "Фантомный вредитель"
L[skin .. "phantom_disruptor.compactname"] = "Фантом"
L[skin .. "phantom_disruptor.description"] = collection.dreams .. "\n" .. [[

На матово-чёрный корпус нанесён рисунок существа туманных очертаний.

«Он может быть чем захочет и где захочет, но всё же предпочитает быть рядом с тобой»]]
------------------------------------
L[skin .. "point_disarray.printname"] = wpns .. "Буйство красок"
L[skin .. "point_disarray.compactname"] = "Буйство"
...
------------------------------------
L[skin .. "winter_sport.printname"] = wpns .. "Снежный вихрь"
L[skin .. "winter_sport.compactname"] = "Снежный в."
L[skin .. "winter_sport.description"] = collection.shadow .. "\n" .. [[

Окрашено в яркие арктические цвета.

«Мне нравится работать в окружении снега… Всегда получается красивый результат», — Хавьер Алвисо, боевик подразделения «Феникс»]]
------------------------------------
L[skin .. "anarchy.printname"] = wpns .. "Неоновая революция"
L[skin .. "anarchy.compactname"] = "Неон"
L[skin .. "anarchy.description"] = collection.gamma2 .. "\n" .. [[

Поверхность оружия покрыта разнообразными наклейками и обильно обрызгана краской.

«Обязательный инструмент любого отряда самоубийц»]]
------------------------------------
L[skin .. "elegantred.printname"] = wpns .. "Красная линия"
L[skin .. "elegantred.compactname"] = "Красная"
L[skin .. "elegantred.description"] = collection.phoenix .. "\n" .. [[

Раскрашено с помощью аквапечати с использованием углеродного волокна и украшено наклейками в виде тонких красных линий.

«Не бойся выжимать всё до предела»]]
------------------------------------
L[skin .. "rubber.printname"] = wpns .. "Вулкан"
L[skin .. "rubber.compactname"] = "Вулкан"
L[skin .. "rubber.description"] = collection.huntsman .. "\n" .. [[

Покрашен вручную на спортивный мотив.]]
------------------------------------
L[skin .. "tribute.printname"] = wpns .. "Пустынный повстанец"
L[skin .. "tribute.compactname"] = "Пустынный"
L[skin .. "tribute.description"] = collection.vanguard .. "\n" .. [[

Оружие было зашкурено, его раскрасили с помощью трафарета, а затем нанесли граффити.

«Люди поймут, за что мы боремся, если сами зададутся этим вопросом», — Наоми, телохранитель Валерии Дженнер]]
------------------------------------

-- [[ Gunsmith ]]
L[skin .. "gold_arabesque.printname"] = wpns .. "Золотая арабеска"
L[skin .. "gold_arabesque.compactname"] = "Золот"
L[skin .. "gold_arabesque.description"] = collection.dust2_2021 .. "\n" .. [[

На прикладе и цевье вручную нанесён замысловатый рисунок. Металлическая часть окрашена в золотой цвет с вкраплениями филиграни.

«Какие ещё козыри остались в рукаве у Бута?»]]
------------------------------------
L[skin .. "colony01_red.printname"] = wpns .. "Орбита, вер. 01"
L[skin .. "colony01_red.compactname"] = "Орбит"
L[skin .. "colony01_red.description"] = collection.hydra .. "\n" .. [[

Вручную нанесён красно-чёрный узор.

«Находка из Колонии-01»]]
------------------------------------
L[skin .. "abstract.printname"] = wpns .. "Музей элиты"
L[skin .. "abstract.compactname"] = "Музей элиты"
...
------------------------------------
L[skin .. "bloodsport.printname"] = wpns .. "Кровавый спорт"
L[skin .. "bloodsport.compactname"] = "Кровавый с."
L[skin .. "bloodsport.description"] = collection.spectrum .. "\n" .. [[

На корпус нанесена красно-чёрная аквапечать, покрытая множеством белых наклеек-логотипов.

«Требуется второй пилот»]]
------------------------------------
L[skin .. "empress.printname"] = wpns .. "Императрица"
L[skin .. "empress.compactname"] = "Императрица"
L[skin .. "empress.description"] = collection.spectrum2 .. "\n" .. [[

На корпус нанесён рисунок, вдохновлённый картой таро «Императрица».

«У богатства много обличий»]]
------------------------------------
L[skin .. "nibbler.printname"] = wpns .. "Колымага"
L[skin .. "nibbler.compactname"] = "Колымага"
L[skin .. "nibbler.description"] = collection.shatteredweb .. "\n" .. [[

Найдено на заброшенной свалке. Корпус покрасили ещё раз поверх старой краски, которая успела обветриться и затереться.

«От судьбы не уйдёшь»]]
------------------------------------
L[skin .. "professional.printname"] = wpns .. "Сланец"
L[skin .. "professional.compactname"] = "Сланец"
...
------------------------------------
L[skin .. "supercharged.printname"] = wpns .. "Топливный инжектор"
L[skin .. "supercharged.compactname"] = "Топливный"
L[skin .. "supercharged.description"] = collection.wildfire .. "\n" .. [[

Корпус винтовки окрашен в ярко-желтый цвет, а магазин выглядит как механизм.
