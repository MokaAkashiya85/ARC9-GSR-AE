...
IncludeCS("skininfo/all-skins-ru.lua")

IncludeCS("all-skins.lua")

-- For the Folders:
-- Rarities
L["moka_csgo_skin_rarity_1"] = "1) Ширпотреб"
L["moka_csgo_skin_rarity_2"] = "2) Промышленное качество"
L["moka_csgo_skin_rarity_3"] = "3) Армейское качество"
L["moka_csgo_skin_rarity_4"] = "4) Запрещённое"
L["moka_csgo_skin_rarity_5"] = "5) Засекреченное"
L["moka_csgo_skin_rarity_6"] = "6) Тайное"
L["moka_csgo_skin_rarity_7"] = "7) Контрабанда"
