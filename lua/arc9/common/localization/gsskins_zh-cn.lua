...
fracture = "Fracture 收藏", -- community_26
...
dreams = "Dreams & Nightmares 收藏", -- community_30
recoil = "迅猛反擊收藏", -- community_31
revolution = "Revolution 收藏", -- community_32

secret = "117 110 117 115 101 100 收藏"
}
...
-- [[ Antiqued ]]
L[skin .. "cartel.printname"] = wpns .. "卡特爾"
L[skin .. "cartel.compactname"] = "卡特爾"
...
-- [[ Custom ]]
L[skin .. "island_floral.printname"] = wpns .. "野蓮"
L[skin .. "island_floral.compactname"] = "野蓮"
...
《只有都不要跟全都要兩種選擇》]]
------------------------------------
L[skin .. "xray.printname"] = wpns .. "X 光"
L[skin .. "xray.compactname"] = "X 光"
L[skin .. "xray.description"] = collection.havoc .. "\n" .. [[

一把以 X 射線圖樣客製化塗裝，似顯示其內部結構的 AK-47。

《一切表露無違的樣子，並非人人都能欣賞……》]]
------------------------------------
L[skin .. "fireserpent.printname"] = wpns .. "火蛇"
L[skin .. "fireserpent.compactname"] = "火蛇"
L[skin .. "fireserpent.description"] = collection.bravo .. "\n" .. [[

這個來自 Ruins 的紀念品塗上了火蛇的意象。

《要在街頭存活，就得學著噴火》]]
------------------------------------
L[skin .. "jaguar.printname"] = wpns .. "美洲豹"
L[skin .. "jaguar.compactname"] = "美洲豹"
L[skin .. "jaguar.description"] = collection.ancient .. "\n" .. [[

槍托和護木刻有精緻美麗的花紋，與側邊的美洲豹客製化塗裝相較之下毫不遜色。

《江山易改，本性可移》]]
------------------------------------
L[skin .. "panther.printname"] = wpns .. "捷豹"
L[skin .. "panther.compactname"] = "捷豹"
L[skin .. "panther.description"] = collection.esports14 .. "\n" .. [[

這武器已被客製化地使用老虎迷彩為背景，塗上了美洲豹的圖案。]]
------------------------------------
L[skin .. "pinstripe.printname"] = wpns .. "翡翠細紋"
L[skin .. "pinstripe.compactname"] = "翡翠細紋"
L[skin .. "pinstripe.description"] = collection.bank .. "\n" .. [[

這把槍的槍托以沼澤橡木製成，槍身則繪有白、綠相間的細紋。

《質疑伊莫珍就是在質疑我。咱們放鬆心情，喝點蘇格蘭威士忌，來談談生意吧。》 - 《父親與鳳凰》卷二]]
------------------------------------
L[skin .. "well_travelled.printname"] = wpns .. "炫富旅人"
L[skin .. "well_travelled.compactname"] = "炫富旅人"
L[skin .. "well_travelled.description"] = collection.baggage .. "\n" .. [[

這武器的槍拖被棕色皮革包覆著。它已去過不少城市了。
...
------------------------------------
L[skin .. "neonrider.printname"] = wpns .. "霓虹騎士"
L[skin .. "neonrider.compactname"] = "霓虹騎士"
...
------------------------------------
L[skin .. "asiimov.printname"] = wpns .. "艾西莫夫"
L[skin .. "asiimov.compactname"] = "艾西莫夫"
...
------------------------------------
L[skin .. "aztec.printname"] = wpns .. "未知秘境"
L[skin .. "aztec.compactname"] = "未知秘境"
...
《Cold to the touch》]]
------------------------------------
L[skin .. "courage.printname"] = wpns .. "碧綠復仇"
L[skin .. "courage.compactname"] = "碧綠復仇"
...
《這裡有回聲嗎？》]]
------------------------------------
L[skin .. "mastery.printname"] = wpns .. "菁英傑作"
L[skin .. "mastery.compactname"] = "菁英傑作"
L[skin .. "mastery.description"] = collection.chroma2 .. "\n" .. [[

其結合了水轉印與仔細的模板法噴漆客製化塗裝，再以熱轉印貼花加上細節。

《謹慎行事，娜歐米……幹妳那行的都活得不久》 - 《盾與蛇》卷二]]
------------------------------------
...
------------------------------------
L[skin .. "phantom_disruptor.printname"] = wpns .. "幻影破壞者"
L[skin .. "phantom_disruptor.compactname"] = "幻影破壞者"
...
------------------------------------
L[skin .. "point_disarray.printname"] = wpns .. "混亂點"
L[skin .. "point_disarray.compactname"] = "混亂點"
...
------------------------------------
L[skin .. "winter_sport.printname"] = wpns .. "撲朔迷離"
L[skin .. "winter_sport.compactname"] = "撲朔迷離"
...
------------------------------------
L[skin .. "anarchy.printname"] = wpns .. "霓虹革命"
L[skin .. "anarchy.compactname"] = "霓虹革命"
...
------------------------------------
L[skin .. "elegantred.printname"] = wpns .. "赤色流線"
L[skin .. "elegantred.compactname"] = "赤色流線"
L[skin .. "elegantred.description"] = collection.phoenix .. "\n" .. [[

此武器使用水轉印方式，以碳纖維和紅條紋的乾轉印貼花進行塗裝。

《不用顧忌於精益求精》]]
------------------------------------
L[skin .. "rubber.printname"] = wpns .. "瓦肯"
L[skin .. "rubber.compactname"] = "瓦肯"
L[skin .. "rubber.description"] = collection.huntsman .. "\n" .. [[

這武器已被客製化地塗上了運動風格的設計繪畫。]]
------------------------------------
...
-- [[ Gunsmith ]]
L[skin .. "gold_arabesque.printname"] = wpns .. "金色阿拉伯風"
L[skin .. "gold_arabesque.compactname"] = "金色阿拉伯風"
L[skin .. "gold_arabesque.description"] = collection.dust2_2021 .. "\n" .. [[

手繪於槍身與握把上的迷人設計，金屬部分更以金線細描增添風味。

「布斯還藏了什麼招數沒出手？」]]
------------------------------------
L[skin .. "colony01_red.printname"] = wpns .. "環球一號"
L[skin .. "colony01_red.compactname"] = "環球一號"
...
《自 COLONY01 回收》]]
------------------------------------
L[skin .. "abstract.printname"] = wpns .. "館藏遊戲菁英"
L[skin .. "abstract.compactname"] = "館藏遊戲菁英"
L[skin .. "abstract.description"] = collection.riptide .. "\n" .. [[

漆有以立體主義手法描繪精銳部隊恐怖份子潛行於 Dust II 中的 A 大道的客製化塗裝。

「任何想像皆能成真」]]
------------------------------------
L[skin .. "bloodsport.printname"] = wpns .. "血紅運動"
L[skin .. "bloodsport.compactname"] = "血紅運動"
...
《徵求副駕駛》]]
------------------------------------
L[skin .. "empress.printname"] = wpns .. "女皇"
L[skin .. "empress.compactname"] = "女皇"
L[skin .. "empress.description"] = collection.spectrum2 .. "\n" .. [[

其已被客製化塗裝，塗裝構想源自於塔羅牌中的皇后。
...
從荒廢垃圾場中尋回，其原始的藍色漆面被重塗、腐蝕、風化。

《無路可跑》]]
------------------------------------
L[skin .. "professional.printname"] = wpns .. "板岩"
L[skin .. "professional.compactname"] = "板岩"
...
「把醫生叫來吧，會派上用場的」]]
------------------------------------
L[skin .. "supercharged.printname"] = wpns .. "油槍"
L[skin .. "supercharged.compactname"] = "油槍"
