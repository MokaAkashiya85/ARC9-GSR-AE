text = {
	...
	["so_jungle"] = { name = "Jungle", desc = "It has individual parts spray-painted solid colors in a jungle color scheme." },
	...
	["cu_catskulls_p90"] = { name = "Death by Kitty", desc = "It has been hydro-dipped with a graphic of overlapping cat skulls." },
	["CSGO_Doomkitty"] = { name = "Doomkitty", desc = "CSGO_Doomkitty" },
	["hy_ddpat"] = { name = "Forest DDPAT", desc = "It has been painted using a Digital Disruptive Pattern (DDPAT) hydrographic.\n\nBy the time you're close enough to notice the pixels it's already too late" },
	...
	["hy_arctic"] = { name = "Arctic Camo", desc = "It has been painted using an arctic camo hydrographic.\n\nSnow is cold; death is colder" },
	...
	["hy_forest"] = { name = "Wood Camo", desc = "It has been painted using a forest camouflage hydrographic.\n\nThe woods can be a dangerous place... never travel alone" },
	...
	["hy_desert"] = { name = "Desert Storm", desc = "It has been painted using a desert camouflage hydrographic." },
	["hy_tiger"] = { name = "Bengal Tiger", desc = "It has been painted using a tiger stripe hydrographic." },
	["hy_copperhead"] = { name = "Copperhead", desc = "It has been painted using a copperhead snakeskin-patterned hydrographic." },
	["hy_skulls"] = { name = "Skulls", desc = "It has been painted using a skull-patterned hydrographic with red or black accents.\n\nA mass grave that fits snugly in the palm of your hands" },
	...
	["hy_ak47lam"] = { name = "Red Laminate", desc = "It has been given a laminate stock." },
	["hy_ak47lam_bw"] = { name = "Black Laminate", desc = "hy_ak47lam_bw" },
	["hy_ak47lam_blue"] = { name = "Blue Laminate", desc = "hy_ak47lam_blue" },
	["hy_gelpen"] = { name = "Gunsmoke", desc = "It has been painted using a hydrographic of a gel pen doodle." },
	["hy_v_tiger"] = { name = "Jungle Tiger", desc = "It has been painted using a jungle tiger hydrographic." },
	...
	["hy_granite"] = { name = "Granite Marbleized", desc = "It has been painted in a marbleized pattern." },
	...
	["sp_leaves"] = { name = "Forest Leaves", desc = "It has been spray-painted using leaves as stencils." },
	["sp_leaves_grassland"] = { name = "Grassland Leaves", desc = "sp_leaves_grassland" },
	["sp_short_tape"] = { name = "Lichen Dashed", desc = "It has been spray-painted using short pieces of tape as stencils." },
	...
	["am_tiger"] = { name = "Gold Tiger", desc = "It has been gold-plated and hand-etched in a tiger stripe pattern." },
	...
	["aa_splash_p250"] = { name = "Splash", desc = "It has been painted by airbrushing transparent paints through a stencil over a chrome base coat." },
	["aa_fade"] = { name = "Fade", desc = "It has been painted by airbrushing transparent paints that fade together over a chrome base coat.\n\nThis isn't just a weapon, it's a conversation piece - Imogen, Arms Dealer In Training" },
	["aa_fade_metallic"] = { name = "Amber Fade", desc = "aa_fade_metallic" },
	["aa_fade_grassland"] = { name = "Acid Fade", desc = "aa_fade_grassland" },
	["aq_copper"] = { name = "Copper", desc = "It has been copper plated." },
	["aq_blued"] = { name = "Blue Steel", desc = "It has been cold blued.\n\nThis is the malbec of weapon design - Booth, Arms Dealer" },
	["aq_forced"] = { name = "Stained", desc = "It has been given a forced patina using lemon and mustard dripped onto the surface.\n\nIf you think it's messy now, wait until you see it under a blacklight" },
	["aq_oiled"] = { name = "Case Hardened", desc = "It has been color case-hardened through the application of wood charcoal at high temperatures.\n\nA little color never hurt anyone" },
	["sp_spitfire_famas"] = { name = "Spitfire", desc = "sp_spitfire_famas" },
	["am_zebra"] = { name = "Slaughter", desc = "It has been painted in a zebra-stripe pattern with aluminum and chrome paints with various reflectivities, and has then been covered with a tomato red candy coat.\n\nValeria doesn't pay Javier to ask questions... she pays him to pry out answers" },
	["am_zebra_dark"] = { name = "Dark Water", desc = "It has been painted in an aquatic-stripe pattern with charcoal metallic paints of various reflectivities over a chrome base coat.\n\nWater gives life, but it can also take it..." },
	...
	["am_slither_p90"] = { name = "Cold Blooded", desc = "It has been painted with a chrome base coat and candied in transparent red anodized effect paint.  It has then been laser-etched with a slithering snake motif." },
	["am_carbon_fiber"] = { name = "Carbon Fiber", desc = "It has been painted using a carbon fiber hydrographic over a graphite base coat.\n\nJust because I carried my team doesn't mean it wasn't a team effort - Rona Sabri, Rising Star" },
	...
	["sp_palm"] = { name = "Palm", desc = "It has been spray-painted using cardboard cutouts, fine mesh, and palm leaves as stencils." },
	["sp_palm_shadow"] = { name = "Tropical Storm", desc = "sp_palm_shadow" },
	["cu_walnut_nova"] = { name = "Walnut", desc = "It has a figured walnut stock." },
	["aq_brass"] = { name = "Brass", desc = "Parts of the weapon have been replaced with brass.\n\nFool's gold" },
	...
	["CSGO_Camo"] = { name = "GO Camo", desc = "It has been painted using a hydrographic in the Global Offensive camo pattern." },
	["CSGO_Icosahedron"] = { name = "Memento", desc = "It has been painted using a geometric-patterned hydrographic." },
	["cu_fireserpent_ak47_bravo"] = { name = "Fire Serpent", desc = "This memento from Ruins has been painted with a fire serpent motif.\n\nIf you want to survive in the streets, learn to spit fire" },
	["cu_favela"] = { name = "Corticera", desc = "It has has been painted with a corticera tree motif." },
	["cu_dragon_p90_bravo"] = { name = "Emerald Dragon", desc = "This memento from Chinatown has been painted with a dragon motif.\n\nTradition can be dangerous" },
	...
	["cu_season_elites_bravo"] = { name = "Black Limba", desc = "This memento from Agency has a dark patina and grips of black limba wood.\n\nWhere classic construction meets modern aesthetics" },
	...
	["an_emerald_bravo"] = { name = "Emerald", desc = "This memento from Chinatown has been painted with a chrome base coat and candied in transparent emerald anodized effect paint.\n\nThis is what the great Sebastien Hennequet has been reduced to? A nagging school marm?  What happened to you... - The Teacher and The Iconoclast Part 2" },
	...
	["am_electric_red"] = { name = "Serum", desc = "It has been painted in a digital pattern with metallic paints of various reflectivities over a chrome base coat." },
	["cu_shark"] = { name = "Blood in the Water", desc = "It has been airbrushed with the image of a shark." },
	...
	["so_orca"] = { name = "Tuxedo", desc = "It has individual parts spray-painted solid colors in a black and white color scheme.\n\nFor when combat is a black tie affair" },
	...
	["cu_m4_asimov"] = { name = "Asiimov", desc = "It has been custom painted with a sci-fi design.\n\nAnyone can predict the future... a visionary shapes it" },
	["cu_sawedoff_octopump"] = { name = "The Kraken", desc = "It has been hand painted with an image of an octopus.\n\nIt has been unleashed" },
	...
	["cu_aug_chameleonaire"] = { name = "Chameleon", desc = "It has been custom painted with the image of a chameleon.\n\nSubtlety can make all the difference" },
	["cu_ump_corporal"] = { name = "Corporal", desc = "It has been custom painted in a military motif.\n\nRespect can never be taken, only earned" },
	...
	["an_famas_sgt"] = { name = "Sergeant", desc = "It has been given a patina of varying depth using masking fluid to create a military motif, sealed with a satin finish.\n\nLead by example" },
	...
	["cu_kaiman"] = { name = "Caiman", desc = "It has been custom painted with an image of a Caiman." },
	["cu_bizon-osiris"] = { name = "Osiris", desc = "It has been custom painted with a high-tech design in black, white, and amber." },
	["cu_c75a-tiger"] = { name = "Tigris", desc = "It has been custom painted with high-gloss paint in a tiger stripe motif." },
	...
	["cu_nova_koi"] = { name = "Koi", desc = "It has been custom painted with variegated koi scales." },
	["cu_p2000_ivory"] = { name = "Ivory", desc = "It has faux ivory parts." },
	["cu_bittersweet"] = { name = "Supernova", desc = "It has been painted with a hydrographic in a cosmic pattern with concentric circles." },
	...
	["hy_craquelure"] = { name = "Blue Fissure", desc = "It has been painted using a hydrographic in a craquelure pattern." },
	["hy_poly_camo"] = { name = "Red FragCam", desc = "It has been painted using a hydrographic of a polygonal camo." },
	...
	["am_chainmail"] = { name = "Chainmail", desc = "It has been painted with a semi-transparent hydrographic in a chainmail pattern over a silver base coat.\n\nOf all the members of The Phoenix, none are more loyal to Valeria than her bodyguard Naomi" },
	...
	["so_indigo_and_grey"] = { name = "Indigo", desc = "It has been painted solid colors in indigo, blue and grey.\n\nAlex Kincaide, I'm sure you have many questions... please allow me to give you answers - The Phoenix and The Storyteller Part 1" },
	["cu_well_traveled_ak47"] = { name = "Jet Set", desc = "Its stock has been wrapped in brown leather.  This weapon has been to a lot of cities.\n\nAnyone paying close attention will connect the dots and see what she did. We don't have much time to find a solution... - A Father's Love Part 1" },
	["cu_green_leather"] = { name = "First Class", desc = "Its stock has been wrapped in green leather.\n\nMimosa not included" },
	...
	["cu_luggage_usp-s"] = { name = "Business Class", desc = "It has been custom painted with colors and patterns inspired by vintage luggage, and had some parts wrapped in brown leather.\n\nSome people don't just want extra leg room... they want peace and quiet" },
	...
	["hy_nuclear_skulls4_p250"] = { name = "Contamination", desc = "It has been painted with a hydrographic pattern of nuclear skulls and bones." },
	...
	["cu_glock_deathtoll"] = { name = "Catacombs", desc = "It has been painted using a hydrographic of skulls over a silver metallic paint base.\n\nIntimidation is the sincerest form of flattery" },
	...
	["sp_labyrinth3"] = { name = "Daedalus", desc = "It has been spray-painted with a stencil of an isometric labyrinth.\n\nImogen... if they ever find out what you did, it may cost us everything - A Family Affair Part 1" },
	...
	["cu_poseidon"] = { name = "Poseidon", desc = "It has been custom painted with a depiction of a battle between Pisces and Poseidon.\n\nThree can keep a secret if two of them are dead" },
	...
	["so_aqua"] = { name = "Seabird", desc = "It has individual parts spray-painted solid colors in an aqua and tan color scheme.\n\nMine." },
	...
	["cu_lore"] = { name = "Lore", desc = "It has been custom painted with knotwork." },
	["cu_stonewash"] = { name = "Black Laminate", desc = "It has been stonewashed and given a black laminate handle." },
	...
	["cu_UMP45_Metritera"] = { name = "Briefing", desc = "It has been given a hydrographic of a topographical map.\n\nThis is going to be a short meeting..." },
	["hy_XM1014_Fractal_Blue"] = { name = "Slipstream", desc = "It has been custom painted with smoky greys and vibrant blues.\n\nPatience, Elliott; they still have a role to play... - The Mercenary and The Serpent Part 2" },
	...
	["ak_porcelain"] = { name = "Inheritance", desc = "This custom paint job takes inspiration from traditional Chinese porcelain and Delft Blauw art.\n\nA \"family\" heirloom, passed through generations" },
	["awp_tempered"] = { name = "Chrome Cannon", desc = "Custom painted with mirror coat paint, this AWP is finished with multicolored accents and a carbon fiber scope.\n\n\"Where'd this come from? Why do you ask?\" - Booth, Arms Dealer" },
	["dual_berettas_lethal_grin"] = { name = "Hideout", desc = "It has been custom painted with a multicolored design.\n\nStep right up, don't be shy" },
	["fiveseven_hybrid"] = { name = "Hybrid", desc = "It has been custom painted with a silver base coat and bright purple stripes.\n\nParty in the front, party in the back" },
	["glock_brick_mondrian"] = { name = "Block-18", desc = "It has been custom painted to section the weapon off into colored blocks.\n\nBlocked and loaded" },
	["m4a4_snakebite"] = { name = "Etch Lord", desc = "It has been custom painted to appear as if it was etched into.\n\nIt's just a phase" },
	["mac10_illusion"] = { name = "Light Box", desc = "It has been custom painted to appear as if you are looking into the back of the MAC-10.\n\nCustom built" },
	["mp7_just_smile"] = { name = "Just Smile", desc = "The blue and purple base coat is finished with a smiley face and the words \"Just Smile\" in yellow.\n\n\"Say cheeeeese\"" },
	["nova_drakkar"] = { name = "Dark Sigil", desc = "It has been custom painted with longships and dragons.\n\nIt emerged from the fog of war" },
	["sawedoff_gamer"] = { name = "Analog Input", desc = "It has been custom painted with diagonal bands of color and the letters \"X\", \"Y\", \"B\", and \"A\".\n\n19 in 99" },
	["tec9_junkyard_engineering"] = { name = "Slag", desc = "It has been custom painted to appear handmade, from the grip to the welding on the receiver.\n\nYou have insurance, right?" },
	["ump45_assembled_engine"] = { name = "Motorized", desc = "This custom paint job resembles a combustion engine, repurposed to be used as a weapon.\n\n\"With routine maintenance this'll last at least 500,000 bullets!\"" },
	["usps_doggy"] = { name = "Jawbreaker", desc = "This custom painted USP-S uses high gloss paint and depicts a dog barking from the grip to the silencer. The silencer reads \"GOOD DOGGY\".\n\nI said \"sit\"!" },
	["xm1014_irezumi"] = { name = "Irezumi", desc = "A snake has been custom painted atop a gold-colored base in a style inspired by the Japanese tattoo art style Irezumi.\n\nSnakes represent wisdom and prophecy, two words which best describe XM1014 users" },
	["zeus_thunder_god"] = { name = "Olympus", desc = "This custom paint job features Zeus, the God of Thunder.\n\nThe air crackles…" },
	["usp_field_snake"] = { name = "027", desc = "This custom paint job features a winged defuser beneath the rear sight and \"027\" near the ejection port.\n\nLight field work" },
	["deagle_calligraff"] = { name = "Calligraffiti", desc = "The slide of this Desert Eagle has been decorated with silver paint pen calligraphy.\n\nThese things take time" },
	["mp5_statics_blue"] = { name = "Statics", desc = "It has been custom painted with a black and blue design.\n\nBlack and blue and bloody all over" },
	["aug_puffer"] = { name = "Luxe Trim", desc = "It has been custom painted to replicate the look and feel of a puffer jacket and finished with bronze accents.\n\nThe premium package" },
	["m249_hypnosis"] = { name = "Hypnosis", desc = "It has been custom painted with an eye catching black and blue hypnotic design.\n\n\"Focus on the sound of my voice\"" },
	["r8_roses_and_guns"] = { name = "Tango", desc = "It has been custom painted with a wooden grip and roses.\n\nWill you accept?" },
	["scar20_fury_topo"] = { name = "Trail Blazer", desc = "It has been custom painted with a monochrome black design and silver inlays.\n\nFOR USE BY AUTHORIZED CT AGENTS ONLY" },
	["m4a4_fusion"] = { name = "Turbine", desc = "It has been custom painted with a wine-colored base.\n\nWARNING: Prolonged firing may cause overheating" },
	["dual_elite_hydro_strike"] = { name = "Hydro Strike", desc = "It has been custom painted in blue and orange. The droplets imply the weapons may still be wet.\n\nThe best weapon is the one your enemies least expect" },
	["mac10_ozaki"] = { name = "Saibā Oni", desc = "It has been custom painted with a cybernetic demon on the side and between the wire stock.\n\nCrackling energy and cold steel" },
	["p90_randy_rush"] = { name = "Randy Rush", desc = "This custom paint job features camouflage, military insignia, and... Randy. For better or worse.\n\n\"Or how I learned to stop worrying and love the P90\"" },
	["ssg08_transit_white"] = { name = "Rapid Transit", desc = "It has been custom painted with fictitious transit diagrams designed around the maps of Counter-Strike.\n\n\"Where are we headed?\"" },
	["ak47_t_bus"] = { name = "The Outsiders", desc = "It has been custom painted with crude depictions of Ts in different situations.\n\nThe Ts on the bus win rounds and rounds, rounds and rounds, rounds and rounds" },
	["p250_impact"] = { name = "Epicenter", desc = "This custom paint job gives the appearance of custom machined parts using an anodized finish.\n\nDirect impact" },
	["glock_chomper"] = { name = "Gold Toof", desc = "It has been custom painted with a pink grip and an aggressive forward-facing gaze.\n\n\"This one's for you!\"" },
	["m4a1s_vaporwave"] = { name = "Vaporwave", desc = "It has been custom painted with a Greco-Roman statue and other distorted imagery from a bygone era.\n\nFrom a hypnagogic dream" },
	["hy_overpass_paintover_teal"] = { name = "Midnight Paintover", desc = "A blue and black hydrographic graffiti pattern has been applied.\n\nSigned, Doctor Romanov" },
	["sp_overpass_doodle_plum"] = { name = "Wash me", desc = "A pink and purple spray-painted graffiti pattern has been applied.\n\nNothing a little elbow grease can't fix" },
	["sp_overpass_paint_pen_neon"] = { name = "Neon Squeezer", desc = "Neon-colored paint pen graffiti doodles have been applied over a dark base.\n\n\"It's art, I shouldn’t have to explain it\"" },
	["hy_overpass_doodle_m4a1s"] = { name = "Wash me plz", desc = "A tan, purple, and gold hydrographic graffiti pattern has been applied.\n\nNothing a little elbow grease can't fix" },
	["cu_overpass_aqua_deagle"] = { name = "Tilted", desc = "Its aqua-colored base has been tagged with graffiti from different artists.\n\n\"I want EVERY round\"" },
	["cu_overpass_graf_negev"] = { name = "Wall Bang", desc = "Its crimson base has been tagged with graffiti from different artists.\n\nHold it down" },
	["sp_overpass_paint_pen_metal"] = { name = "Metallic Squeezer", desc = "Metallic paint pen graffiti has been applied over a flat black base.\n\n\"It's art, I shouldn’t have to explain it\"" },
	["cu_overpass_squeak_mac10"] = { name = "Pipsqueak", desc = "The rat near the rear sight is surrounded by black and blue graffiti.\n\nGame on" },
	["cu_overpass_wurst_nova"] = { name = "Wurst Hölle", desc = "It has been custom painted using sausages from Wurst Hölle, the biergarten on Overpass.\n\nLook no further, you've found the missing link" },
	["hy_overpass_tagged_teal"] = { name = "Teal Graf", desc = "A blue and red hydrographic graffiti pattern has been applied.\n\nDot your \"t\"s and cross your \"i\"s" },
	["cu_overpass_baby_dualies"] = { name = "Sweet Little Angels", desc = "Two cherubs have been custom painted over a bright-colored graffiti base.\n\nAww, look how… precious they are" },
	["cu_overpass_monsters_xm"] = { name = "Monster Melt", desc = "A collection of monsters has been custom painted on both sides of this XM1014.\n\n\"Best to not check the other side\"" },
	["cu_overpass_graf_aug"] = { name = "Eye of Zapems", desc = "It has been painted with custom graffiti from Zapems, the infamous street graffiti artist from Overpass.\n\n\"Check the cameras, we need to find who's doing this\"" },
	["cu_overpass_crakow_awp"] = { name = "Crakow!", desc = "It has been custom painted using whimsical, playground-style art depicting a little girl and her robot.\n\nPlaying make believe" },
	["cu_overpass_dragon_zeus"] = { name = "Dragon Snore", desc = "A dragon wraps around this lighthearted, custom painted x27.\n\nFrom the highest room of the tallest tower" },
	["cu_overpass_monster_ak47"] = { name = "B the Monster", desc = "It has been custom painted with graffiti from the monster tunnel on Overpass and is finished with metallic silver and gold accents.\n\nThere's no turning back now…" },
	["ht_blur_camo_mp5sd"] = { name = "Savannah Halftone", desc = "It has been custom painted using a sand and olive-colored halftone design.\n\nObserve in silence, then make yourself known" },
	["soch_tiger_stencil"] = { name = "Tiger Stencil", desc = "A smoke and sand-colored tiger pattern has been applied.\n\nThe title \"King of the Jungle\" is up for debate" },
	["gsch_zeno_ssg08"] = { name = "Zeno", desc = "It has been custom painted using grayscale metallic flake paint and features red diamond accents.\n\nWhen a LOT of chrome just isn't enough" },
	["gs_gamebred_famas"] = { name = "Half Sleeve", desc = "It has been custom painted to appear as if it's wrapped in a camo patterned jacket.\n\nHalf sleeved and fully loaded" },
	["ht_poly_camo"] = { name = "Olive Polycam", desc = "It has been custom painted using a green and grey halftone pattern.\n\nAttention to detail" },
	["sp_wax_rub_bizon"] = { name = "Cold Cell", desc = "It has been spray painted with a blue pebble pattern.\n\nYour intentions are clear" },
	["soch_hunter_blaze"] = { name = "Small Game", desc = "A camouflage hunter pattern has been applied to the bottom half of this P250.\n\nThe hunted becomes the hunter" },
	["soch_wildwood"] = { name = "Wildwood", desc = "A pattern of \"Wildwood\" branches and leaves has been applied.\n\n\"Are you lost?\"" },
	["gs_ripple_nova"] = { name = "Yorkshire", desc = "It has been custom painted using high gloss bronze and gold paint.\n\nA history of violence" },
	["gsch_bright_camo_usp"] = { name = "Alpine Camo", desc = "It has been custom painted with a blue and purple camouflage.\n\nPulled out of cold storage" },
	["aq_case_hardened_2"] = { name = "Heat Treated", desc = "It has been color case-hardened through the application of wood charcoal at high temperatures.\n\nA little color never hurt anyone" },
	["gs_arctic_mp9"] = { name = "Arctic Tri-Tone", desc = "This custom paint job features white and blue color blocking and is finished with a matching camouflage.\n\nFrigid finality" },
	["gsch_sport_ump45"] = { name = "Crimson Foil", desc = "It has been custom painted with a striking red and silver color blocked design.\n\nSolving hard problems one magazine at a time" },
	["aq_titanium_rainbow"] = { name = "Rainbow Spoon", desc = "The rainbow spoon effect is achieved by heating the painted weapon to very high temperatures. By using this method the number of unique finishes is almost infinite.\n\nInfinite possibilities" },
	...
	["ht_peaks_rainbow"] = { name = "Spectrogram", desc = "It has been custom painted using a green and blue halftone pattern.\n\nThis one's off the charts" },
	["ht_swirl"] = { name = "Halftone Whorl", desc = "It has been custom painted with a blue and green halftone whorl pattern.\n\nHandle with care" },
	["ht_splash"] = { name = "Halftone Wash", desc = "It has been custom painted with a blue and grey halftone splash pattern.\n\nEven the calmest waters can quickly change" },
	["gs_constellation_dark_mp7"] = { name = "Astrolabe", desc = "A metallic design has been applied over a dark-colored base.\n\n\"IT'S NOT A CIRCUIT BOARD!\"" },
	["cu_poly_green_galil"] = { name = "NV", desc = "It has been custom painted with a dark grey base and finished with green accents.\n\nGoing dark" },
	["ht_facet_p2000"] = { name = "Coral Halftone", desc = "It has been custom painted using a multicolored halftone pattern.\n\nWatch your tone" },
	["cu_chevron_scar20"] = { name = "Wild Berry", desc = "It has been custom painted using a multicolored halftone design.\n\n\"I can't aim\"" },
	["gs_happy_red_sg556"] = { name = "Berry Gel Coat", desc = "It has been custom painted with a metallic bronze base and finished with red accents.\n\n\"Aww, look at the lil' fella\"" },
	["cu_graphic_overlay_ak47"] = { name = "Crossfade", desc = "It has been custom painted with a multicolored graphic design.\n\nCaught between frames" },
	["ht_shapes"] = { name = "Halftone Shift", desc = "It has been custom painted using a multicolored halftone design.\n\n\"It's from a zoo, but instead of animals on display it's art\"" },
	["cu_abstract_white_cz"] = { name = "Slalom", desc = "It has been custom painted with a multicolored abstract design.\n\nBlack diamond gun" },
	["cu_poly_violet_p90"] = { name = "Attack Vector", desc = "It has been custom painted with a multicolored abstract design.\n\nAggressive angles of attack" },
	["soo_polysoup_m4a4"] = { name = "Polysoup", desc = "It has been custom painted with multicolored crystals and finished with pearlescent accents.\n\nDon't stew on it" },
	["cu_glitter_deagle"] = { name = "Starcade", desc = "It has been custom painted with an abstract design using metallic flake paint.\n\nA New High Score!" },
	["gs_lilpig_aug"] = { name = "Lil' Pig", desc = "This custom paint job features a red base and metallic gold accents. A red pig has been added near the butt stock.\n\nAt home on the range" },
	["gs_independe_awp"] = { name = "CMYK", desc = "It has been custom painted with a multicolored abstract design over a white base.\n\nI knew you'd return; I just didn't expect it to be so soon... – Booth, Arms Dealer" },
	...
	["sp_palm_bravo"] = { name = "sp_palm_bravo", desc = "This memento from Gwalior been spray-painted using cardboard cutouts, fine mesh, and palm leaves as stencils.\n\nBeautiful today...ashes tomorrow" },
	...
	["m4a1s_black_lotus"] = { name = "m4a1s_black_lotus", desc = "It has been custom painted with a black lotus flower over a blue and purple base.\n\nAdds 2 kills during rifle round, then is discarded" },
	["ssg08_dezastre"] = { name = "ssg08_dezastre", desc = "It has been custom painted with a high tech black, white, and red design.\n\nAlways follow manufacturer guidelines for safe use" },
	["ump45_neo_noir"] = { name = "ump45_neo_noir", desc = "It has been custom painted with a stylized blue-magenta woman over a grayscale background.\n\n\"Blade in hand, she decided it was time to take a stand\"" },
}
