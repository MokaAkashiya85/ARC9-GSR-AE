...
secret = "The 117 110 117 115 101 100-kollektionen"
}
...
Det här minnet från Ruins har målats med ett eldormsmotiv.
...
Den har egenmålats med en bild på en panter över en bakgrund av tigerkamouflage.]]
------------------------------------
...
Den har fått en kolv av kärrek och målats med vita och gröna kritstreck.
...
Dess kolv har blivit invirad i brunt läder. Detta vapen har varit i en hel del städer.
...
"Jag gillar att arbeta i snön... det lämnar alltid så fina märken" - Javier Alviso, Fist of the Phoenix]]
------------------------------------
L[skin .. "anarchy.printname"] = wpns .. "Neon Revolution"
L[skin .. "anarchy.compactname"] = "Neon"
L[skin .. "anarchy.description"] = collection.gamma2 .. "\n" .. [[

Den har givits en eklektisk blandning av hydrografiska dekaler och sedan fått droppar med färg.
...
Den har målats hydrografiskt med kolfiber och en röd kritstrecksdekal.
...
Den har målats med en sportinspirerad design.]]
------------------------------------
...
En invecklad design har handmålats på kolv och handskydd. Metallen har målats i guld och är prydd med filigrans.
...
Den har målats med en kubistisk skildring av terrorister från Elite Crew som smyger längs A-long i Dust II.
...
Gevärets stomme har målats skrikande gul och magasinet har målats speciellt så det liknar maskindelar.
...
Den har blivit egenmålad med en drake i knutverk.
...
Den har blivit målad med ett corticeraträdsmotiv.]]
------------------------------------
...
"Du vill verkligen imponera på mig, Booth? Gör denna UV-ljuskänslig" - Rona Sabri, Rising Star]]
------------------------------------
L[skin .. "mastery.printname"] = wpns .. "Elite Build"
L[skin .. "mastery.compactname"] = "Elite Build"
L[skin .. "mastery.description"] = collection.wildfire .. "\n" .. [[

Den har specialmålats med en kombination av hydrografik och noggrann stencilering samt detaljerats med värmekänsliga dekaler.
...
Den har målats med ett motiv som består av komplexa turkosfärgade och korallröda stråk.
...
En skarp grön och blå buskhuggorm har målats för hand på en svart grundfärg.
